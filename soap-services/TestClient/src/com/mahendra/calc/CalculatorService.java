 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calc.mahendra.com/", wsdlLocation = "http://localhost:3000/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calc.mahendra.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:3000/calc?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calc.mahendra.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.mahendra.com/", "CalculatorPort"), Calculator.class, features);
    }
