 ...
 * 
 */
@WebServiceClient(name = "AccountServiceService", targetNamespace = "mahendra.com", wsdlLocation = "http://localhost:3000/acc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICESERVICE_QNAME = new QName("mahendra.com", "AccountServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:3000/acc?wsdl");
    ...
    public AccountService getAccountServicePort() {
        return super.getPort(new QName("mahendra.com", "AccountServicePort"), AccountService.class);
    }
    ...
    public AccountService getAccountServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("mahendra.com", "AccountServicePort"), AccountService.class, features);
    }
